-- Role: anacleto
-- DROP ROLE IF EXISTS anacleto;

CREATE ROLE anacleto WITH
  LOGIN
  SUPERUSER
  INHERIT
  CREATEDB
  CREATEROLE
  REPLICATION
  ENCRYPTED PASSWORD 'SCRAM-SHA-256$4096:2Q2n8KQlaraNnVdECed7kQ==$szA3pO5mX8X887qCMV9sfJSjzo/CMQ679oUjDyyTAZg=:T6m2RN6MMgHgpvfiuE78dcUnimzKuyFcpzrAz9Dcch4=';
...
COMMENT ON DATABASE uvv
    IS 'Criacao de Banco de Dados UVV';
...
CREATE SCHEMA IF NOT EXISTS hr
    AUTHORIZATION anacleto;

COMMENT ON SCHEMA hr
    IS 'Criacao do Schemas hr';
...
COMMENT ON hr.historico_cargos
...
COMMENT ON table hr.empregados
    IS 'Inserindo os dados referentes aos empregados, importados do Oracle';
...
INSERT INTO hr.historico_cargos (id_empregado, data_inicial, data_final, id_cargo, id_departamento) VALUES
( '103', '28-OCT-01', '15-MAR-05', 'AC_MGR', '110');
INSERT INTO hr.historico_cargos (id_empregado, data_inicial, data_final, id_cargo, id_departamento) VALUES
...
INSERT INTO hr.historico_cargos (id_empregado, data_inicial, data_final, id_cargo, id_departamento) VALUES
( '176', '02-JAN-07', '31-DEC-07', 'SA_MAN', '80');
INSERT INTO hr.historico_cargos (id_empregado, data_inicial, data_final, id_cargo, id_departamento) VALUES
( '202', '01-JUL-02', '31-DEC-06', 'AC_ACCOUNT', '90');


COMMENT ON table hr.historico_cargos
    IS 'Inserindo os dados referentes as historico_cargos, importados do Oracle';
